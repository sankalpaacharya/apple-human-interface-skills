...
![A stylized representation of a window with close, minimize, and full-screen buttons. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](https://docs-assets.developer.apple.com/published/366b0f4760421a57abd542a59f8848ea/components-window-intro%402x.png)
...
> **Note**
>
> visionOS also defines the *plain* window style, which is similar to the default style, except that the upright plane doesn’t use the glass background. For developer guidance, see [PlainWindowStyle](https://developer.apple.com/documentation/SwiftUI/PlainWindowStyle).
