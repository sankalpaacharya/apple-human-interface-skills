...
[▶ video](https://docs-assets.developer.apple.com/published/bab0ee20b58150127a28d50aa69d13dd/visionos-app-icon-showcase.mp4)
...
![An image of the Settings icon for iOS. The iOS, iPadOS, and macOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.](https://docs-assets.developer.apple.com/published/927ba01cf5a9bd7962af41c03751ab05/app-icons-settings-app-grid-square%402x.png)

**tvOS**


![An image of the Settings icon for tvOS. The tvOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.](https://docs-assets.developer.apple.com/published/47757fef3b9fde8f51bcffe483877241/app-icons-settings-app-grid-rectangle%402x.png)

**visionOS, watchOS**


![An image of the Settings icon for watchOS. The visionOS and watchOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.](https://docs-assets.developer.apple.com/published/a247efec254c488dc0df97c654e8ccf3/app-icons-settings-app-grid-circle%402x.png)
